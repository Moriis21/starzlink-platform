...
export default function LoginPage() {
  ...
  const handleOAuth = async (provider: "google" | "linkedin") => {
    ...
    try {
      ...
      toast.error(`${provider === "google" ? "Google" : "LinkedIn"} login is unavailable right now.`);
        ...
        <div className="flex-1 p-6 sm:p-10">
          ...
          <div className="space-y-3 mb-5">
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 border-2 border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:border-blue-300 hover:bg-blue-50 transition-all disabled:opacity-60"
            >
              {oauthLoading === "google"
            ...
            <motion.button
              ...
              disabled={!!oauthLoading}
              className="w-full flex items-center justify-center gap-3 py-3 border-2 border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:border-blue-400 hover:bg-blue-50 transition-all disabled:opacity-60"
            >
              {oauthLoading === "linkedin"
                ? <span className="w-4 h-4 border-2 border-gray-200 border-t-[#0A66C2] rounded-full animate-spin" />
