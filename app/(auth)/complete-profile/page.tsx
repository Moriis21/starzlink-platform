          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <input value={form.county_state} onChange={set("county_state")} placeholder="e.g. Montserrado, Lagos, Greater Accra"
                  className={cn("w-full border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#1a3c8f]", errors.county_state ? "border-red-400" : "border-gray-200")} />
